	...
	return (
		...
		<div className=" animate__animated animate__fadeIn politica-privacidad-container">
			...
			<p>
				...
				GenshinBuilds usa y protege la información que es proporcionada por sus
			...
			<br/>
			<p>
				GenshinBuilds está altamente comprometido para cumplir con el compromiso de
			...
			<br/>
			<p>
				GenshinBuilds Se reserva el derecho de cambiar los términos de la presente
